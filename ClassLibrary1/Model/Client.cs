...
namespace SmartHomeSystem.DAL.Model
{
    public class Client : Person
    {
        ...
        public bool Insert(string name, string surname, int age, string idno, DateTime dob, string cellno, string address1, string address2, string city, int postalcode, string country)
        {
            DataHandler dataHandler = new DataHandler();
        ...
        public bool Update(string name, string surname, int age, string cellno, string address1, string address2, string city, int postalcode, string country, int id)
        {
            DataHandler dataHandler = new DataHandler();
